<header class="ap-header-area" id="ap-header-sticky">
    <div class="ap-header-inner">
        <div class="ap-header-logo">
            ...
            <?php else: ?>
            <div class="ap-header-logo-placeholder"><?php echo e(substr($profile?->name ?? 'P', 0, 1)); ?></div>
...
<?php /**PATH C:\xampp\htdocs\laravel-portfolio\resources\views/components/header.blade.php ENDPATH**/ ?>