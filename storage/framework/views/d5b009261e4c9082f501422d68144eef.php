<section id="blog" class="ap-section-gap" style="background: var(--bg-section-alt);">
    <div class="container">
        ...
        <div class="ap-blog-grid" id="ap-blog-grid">
            ...
            <a href="<?php echo e(route('post.show', $post->slug)); ?>" class="ap-blog-card" data-type="<?php echo e($post->type); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->type === 'award'): ?>
                ...
                <div class="ap-blog-body">
                    ...
                    <span class="ap-blog-date">
                        ...
                        <?php echo e($post->date->format('M d, Y')); ?>

                    </span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <h3 class="ap-blog-title"><?php echo e($post->title); ?></h3>
                    ...
                    <p class="ap-blog-excerpt"><?php echo e(Str::limit($post->content, 120)); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span class="ap-blog-link">
                        <?php echo e($post->type === 'blog' ? 'Read More' : 'View Details'); ?>
...
<?php /**PATH C:\xampp\htdocs\laravel-portfolio\resources\views/components/blog-awards.blade.php ENDPATH**/ ?>