        ...
        <div class="ap-footer-content">
            <div class="ap-footer-brand">
                <a href="#home" class="logo">
                    ...
                    <?php else: ?>
                    <div class="placeholder"><?php echo e(substr($profile?->name ?? 'P', 0, 1)); ?></div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <span><?php echo e($profile?->name ?? 'Portfolio'); ?></span>
                </a>
                <p><?php echo e($profile?->short_bio ?? "Building digital experiences that make a difference."); ?></p>
                <div class="ap-footer-social">
                    ...
                    <a href="<?php echo e($link->url); ?>" target="_blank" aria-label="<?php echo e($link->platform); ?>">
                        <?php $p = strtolower($link->platform); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(strpos($p, 'twitter') !== false || strpos($p, 'x.') !== false): ?>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        <?php elseif(strpos($p, 'github') !== false): ?>
                        ...
                        <?php elseif(strpos($p, 'dribbble') !== false): ?>
            ...
            <div class="ap-footer-widget">
                <h4>Get in Touch</h4>
                <a href="mailto:<?php echo e($profile?->email ?? 'hello@domain.com'); ?>"><?php echo e($profile?->email ?? 'hello@domain.com'); ?></a>
                <span><?php echo e($profile?->location ?? 'Sydney, Australia'); ?></span>
                <a href="#contact" class="ap-btn-primary" style="display: inline-flex; margin-top: 12px; padding: 10px 20px; font-size: 12px;">
                    Hire Me
                </a>
            </div>
        </div>
        <div class="ap-footer-bottom">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($profile?->name ?? 'Portfolio'); ?>. All Rights Reserved.</p>
        </div>
    </div>
</footer>
<?php /**PATH C:\xampp\htdocs\laravel-portfolio\resources\views/components/footer.blade.php ENDPATH**/ ?>