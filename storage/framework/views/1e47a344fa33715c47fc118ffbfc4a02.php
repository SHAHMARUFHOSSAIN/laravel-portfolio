        ...
        <div class="ap-portfolio-grid">
            ...
            <div class="ap-portfolio-item">
                <div class="ap-portfolio-thumb">
                    ...
                    <img src="<?php echo e(Storage::url($project->image)); ?>" alt="<?php echo e($project->title); ?>">
                    <?php else: ?>
                    ...
                    <div class="ap-portfolio-overlay">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->live_url): ?>
                        <a href="<?php echo e($project->live_url); ?>" target="_blank" class="ap-portfolio-link" title="Live Preview">
                        ...
                        <a href="<?php echo e($project->github_url); ?>" target="_blank" class="ap-portfolio-link" title="Source Code">
                ...
                <div class="ap-portfolio-info">
                    ...
                    <h3 class="ap-portfolio-title"><?php echo e($project->title); ?></h3>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\xampp\htdocs\laravel-portfolio\resources\views/components/projects.blade.php ENDPATH**/ ?>