<section id="contact" class="ap-section-gap" style="background: var(--bg-body);">
    <div class="container">
        ...
        <div class="ap-contact-grid">
            <div class="ap-contact-info">
                <div class="ap-contact-info-item">
                    ...
                    <div>
                        ...
                        <a href="mailto:<?php echo e($profile?->email ?? 'hello@domain.com'); ?>" class="ap-contact-info-value"><?php echo e($profile?->email ?? 'hello@domain.com'); ?></a>
                    </div>
                </div>
                <div class="ap-contact-info-item">
                    <div class="ap-contact-info-icon">
                    ...
                    <div>
                        ...
                        <span class="ap-contact-info-value"><?php echo e($profile?->location ?? 'Sydney, Australia'); ?></span>
                    </div>
                </div>
                <div class="ap-contact-info-item">
                    <div class="ap-contact-info-icon">
            ...
            <form action="<?php echo e(route('contact.store')); ?>" method="POST" class="ap-contact-form">
                <?php echo csrf_field(); ?>
                ...
                <input type="text" name="subject" value="<?php echo e(old('subject')); ?>" placeholder="Subject">
                <textarea name="message" rows="5" placeholder="Your Message *" required><?php echo e(old('message')); ?></textarea>
...
<?php /**PATH C:\xampp\htdocs\laravel-portfolio\resources\views/components/contact.blade.php ENDPATH**/ ?>