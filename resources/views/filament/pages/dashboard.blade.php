    ...
    <div class="dashboard-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card stat-messages">
                ...
                <div class="stat-content">
                    ...
                    @if($unreadContacts > 0)
                        <span class="stat-badge">{{ $unreadContacts }} new</span>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="quick-links">
            ...
            <div class="links-grid">
                <a href="{{ url('/admin/projects') }}" class="quick-link">
                ...
                <a href="{{ url('/admin/skills') }}" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                    <span>Add Skill</span>
                </a>
                <a href="{{ url('/admin/experiences') }}" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                    <span>Add Experience</span>
                </a>
                <a href="{{ url('/admin/services') }}" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                    <span>Add Service</span>
                </a>
                <a href="{{ url('/admin/testimonials') }}" class="quick-link">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" /></svg>
                    <span>Add Testimonial</span>
                </a>
                <a href="{{ url('/admin/contacts') }}" class="quick-link">
                ...
                <a href="{{ url('/admin/profiles') }}" class="quick-link">
                ...
                <a href="{{ url('/') }}" target="_blank" class="quick-link quick-link-view">
