<section id="home" class="ap-doctor-banner-area">
    ...
    <div class="ap-doctor-banner-content">
        <div class="ap-doctor-banner-text">
            ...
            <h1>Hi, I'm <span>{{ $profile?->name ?? 'Alex' }}</span></h1>
            <p class="ap-doctor-banner-subtitle ap-doctor-banner-subtitle-2">{{ $profile?->title ?? 'Full Stack Developer & UI/UX Designer' }}</p>
            <p class="ap-doctor-banner-intro">{{ $profile?->short_bio ?? "I craft fast, accessible, and visually engaging digital experiences that blend clean code with thoughtful design." }}</p>
            ...
            <div class="ap-doctor-banner-stats">
                <div>
                    <span class="ap-doctor-banner-stat-value">{{ $experiences->count() }}+</span>
                    <span class="ap-doctor-banner-stat-label">Years Experience</span>
                </div>
                <div>
                    <span class="ap-doctor-banner-stat-value">{{ $projects->count() }}+</span>
                    <span class="ap-doctor-banner-stat-label">Projects Done</span>
                </div>
                <div>
                    <span class="ap-doctor-banner-stat-value">{{ $services->count() }}+</span>
        ...
        <div class="ap-doctor-banner-thumb">
            <div class="thumb-wrapper">
                ...
                <div class="ap-doctor-banner-info-card ap-doctor-banner-info-card-2">
                    ...
                    <span>{{ $experiences->count() }}+ Years Exp.</span>
                </div>
            </div>
        </div>
    </div>
