        ...
        <div class="ap-footer-content">
            <div class="ap-footer-brand">
                <a href="#home" class="logo">
                    ...
                    @else
                    <div class="placeholder">{{ substr($profile?->name ?? 'P', 0, 1) }}</div>
                    @endif
                    <span>{{ $profile?->name ?? 'Portfolio' }}</span>
                </a>
                <p>{{ $profile?->short_bio ?? "Building digital experiences that make a difference." }}</p>
            ...
            <div class="ap-footer-widget">
                <h4>Get in Touch</h4>
                <a href="mailto:{{ $profile?->email ?? 'hello@domain.com' }}">{{ $profile?->email ?? 'hello@domain.com' }}</a>
                <span>{{ $profile?->location ?? 'Sydney, Australia' }}</span>
